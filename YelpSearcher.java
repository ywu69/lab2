...
public class YelpSearcher {
	 ...
	 * using the Search API to query for businesses by a search term and
	 * location, and the Business API to query additional information about the
	 * top result from the search query.
	 * 
	 * <p>
...
//	private String DEFAULT_LOCATION;
	 ...
	 *            Token secret
	 */
	public YelpSearcher(String consumerKey, String consumerSecret,
			String token, String tokenSecret, int limit) {
		this.service = new ServiceBuilder().provider(YelpTwoStepOAuth.class)
...
//		System.out.println("Querying " + request.getCompleteUrl() + " ...");
	 ...
	 */
//	private static void queryAPI(YelpSearcher yelpApi, YelpAPICLI yelpApiCli) {
...
//
//		YelpSearcher yelpApi = new YelpSearcher(CONSUMER_KEY, CONSUMER_SECRET,
//				TOKEN, TOKEN_SECRET);
